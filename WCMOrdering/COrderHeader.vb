...
Public Class COrderHeader
    ...
    Public Sub Add(ByVal intId As Integer, ByVal bytTS As Byte(), ByVal intProductId As Integer, ByVal strCode As String, ByVal strProduct As String,
    ...
    Public Sub GetProductCodes()
        ...
        Try
            If ShowProductCodes_Supplier OrElse ShowProductCodes_Supplier_Produce Then
                lDB = New DB
                lDB.Open()
        ...
        Try
            ...
            If dr.HasRows Then
                ...
                Else
                    ...
                    ServingAccNum = If(IsDBNull(dr("coh_serving_acc_num")), Nothing, dr("coh_serving_acc_num"))
                    DepotId_Produce = Nz(Of Integer)(dr("coh_depot_id_produce"), 0)
